...
use bkief29\DTO\FieldValidator;
...
class FieldValidatorTest extends TestCase
{
    ...
    public function types_are_validated()
    {
        ...
        $this->assertTrue((new FieldValidator('/** @var \bkief29\DTO\Tests\Foo */'))->isValidType(new Foo));
        $this->assertTrue((new FieldValidator('/** @var \bkief29\DTO\Tests\Foo */'))->isValidType(new FooChild));

        $this->assertFalse((new FieldValidator('/** @var string */'))->isValidType(1));
        $this->assertFalse((new FieldValidator('/** @var \bkief29\DTO\Tests\Foo */'))->isValidType(new Bar));
    }
}
